...
st.set_page_config(page_title="Kitchen Brain – MVP (Planning Add‑ons)", page_icon="🍝", layout="wide")
st.title("🍝 Kitchen Brain – MVP (Planning Add‑ons)")
st.caption("Inventory‑aware specials with expiry/surplus logic, plus planning tools.")
...
st.markdown("Made with ❤️ for your MVP demo — Planning add‑ons enabled (no animations).")
